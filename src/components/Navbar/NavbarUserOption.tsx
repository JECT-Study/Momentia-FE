...
const NavbarUserOption = () => {
  ...
  return (
    <div className='relative flex align-center' ref={targetRef}>
      ...
      />
      {toggleOptionArea && (
        <div className='absolute -left-[201px] top-[50px] w-[327px] h-[342px] bg-notice-base text-white rounded-2xl'>
          <div className='absolute top-[-8px] left-2/3 transform -translate-x-1/2 w-0 h-0 border-l-[15px] border-l-transparent border-r-[15px] border-r-transparent border-b-[15px] border-b-notice-base' />
          <div className='flex flex-col h-full subtitle1'>
            ...
            <button className='flex-1 flex items-center px-[40px] py-[30px] hover:bg-notice-selected'>
              내 프로필
            </button>
            <button
              className='flex-1 flex items-center px-[40px] py-[30px] hover:bg-notice-selected'
